...
enum parse_inst_enum {DP3, BX, MEM, MUL};
...
struct parse_node_st {
    ...
    union {
        struct {
            ...
            union {
                struct {int imm; int rd; int rn; int rm;} dp3;
                struct bx {int rn;} bx;
                struct {int imm; int rd; int rn; int rm;} mem;
                struct {int rd; int rn; int rs; int rm;} mul;
            };
        } inst;
        struct {
